---
output: pdf_document
geometry: "top = 0.75in, left = 0.4in, right = 0.4in, bottom = 0.1in"
header-includes: 
  - \usepackage{booktabs}
  - \usepackage{nopageno}
---
...
\large Table: Critical values of $F, \, \alpha = 0.001$
\vspace{0.2in}
...
\large Table: Critical values of $F, \, \alpha = 0.001$ (continued)
\vspace{0.2in}
