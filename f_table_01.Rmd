...
\large Table: Critical values of $F, \, \alpha = 0.01$
\vspace{0.2in}
...
\large Table: Critical values of $F, \, \alpha = 0.01$ (continued)
\vspace{0.2in}
...
ggplot(data.frame(x = c(0, 6))) +
  ...
  scale_x_continuous(limits = c(0, 6), breaks = c(0, shaded_cutoff), 
    labels = c(0, expression(italic("F")[alpha]))    # make this an input
  ) +
  labs(x = "", y = "") +
  theme(
    axis.text.y = element_blank(), axis.ticks = element_blank(),
